...
class WeightsSaver(Callback):
    ...
    def on_epoch_end(self, epoch, logs={}):
        if self.epoch % self.N == 0:
            name = 'script1model7_50try01%05d.h5' % self.epoch
...
#We train only the last 2 convolutional layers
...
model.compile(optimizer= SGD(lr=0.0002, momentum=0.3, decay=0.000001, nesterov=True   ),
