...
early_stopping = EarlyStopping(monitor='loss', patience=10) # stop after 15 worst results than best
...
class WeightsSaver(Callback):
    ...
    def on_epoch_end(self, epoch, logs={}):
        if self.epoch % self.N == 0:
            name = 'script1model9_50try01%05d.h5' % self.epoch
...
model.compile(optimizer=
              SGD(lr=0.00002, momentum=0.1, decay=0.000001, nesterov=True   ),
